...
export const BERANGKAT_MENDATANG_WINDOW_DAYS = 60;
...
export function buildBerangkatMendatang(rows, todayStr) {
  ...
  const berangkatBulanIni = upcomingRows
    .map(row => ({
      ...
      // Itinerary sudah terurai di tabel `itineraries` → link share layak
      // disalin agen. Lihat lib/berangkat-enrich.js.
      itinerary_ready: !!row.itinerary_ready,
      jk: row.jk,
