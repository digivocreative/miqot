...
">
  ...
  <div style="display:flex;justify-content:space-between;align-items:center;position:relative;z-index:2;">
    ...
    <div style="width:300px;display:flex;justify-content:flex-end;flex-shrink:0;">
      <img src="${escHtml(logoSrc)}" alt="Alhijaz"
           style="height:150px;width:auto;opacity:0.96;" />
    </div>
  </div>

  <!-- USD hero -->
  <div style="margin-top:74px;position:relative;z-index:2;">
    <div style="display:inline-flex;align-items:center;gap:20px;margin-bottom:30px;padding:16px 24px 16px 18px;border-radius:999px;background:rgba(255,255,255,0.12);border:1px solid rgba(255,255,255,0.22);box-shadow:0 20px 60px rgba(0,0,0,0.14);">
      ${flagUsSvg(62)}
      ...
      <span style="font-size:28px;font-weight:600;color:#D1FAE5;white-space:nowrap;">US Dollar</span>
    </div>
    ...
    <div style="display:flex;align-items:center;gap:16px;margin-top:26px;font-size:34px;color:#D1FAE5;font-weight:600;">
      ...
      <span style="white-space:nowrap;">per 1 USD</span>
    </div>
  </div>
  ...
  <div style="display:flex;justify-content:space-between;align-items:center;padding:26px 30px;border-radius:34px;background:rgba(3,59,45,0.74);border:1px solid rgba(248,223,161,0.22);box-shadow:0 24px 80px rgba(0,0,0,0.18);position:relative;z-index:2;">
