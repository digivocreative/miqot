...
- "Brosur" menunjuk DUA hal berbeda, jangan tertukar. (a) BROSUR PAKET: gambar brosur SATU keberangkatan — dipicu kalau agent menyebut paket/tanggal/jadwal_id tertentu ("brosur paket 22 Agustus", "brosur JBU1529") → media {"type": "brosur", "jadwal_id": "..."}. (b) BROSUR JADWAL: daftar keberangkatan SEBULAN yang dipakai agent untuk menyebar promosi — dipicu kata "brosur jadwal", "brosur bulanan", "brosur semua paket", "brosur Agustus", atau minta brosur tanpa menyebut satu paket pun → media {"type": "brosur_jadwal", "bulan": "YYYY-MM"} dengan bulan yang diminta (kosongkan "bulan" bila agent tidak menyebut bulan). Brosur jadwal TIDAK butuh tool apa pun dan TIDAK memakai jadwal_id — jangan mengisinya dengan brosur paket satu per satu.
...
- media: HANYA saat agent minta brosur/itinerary — [{"type": "brosur", "jadwal_id": "..."}], {"type": "itinerary", "jadwal_id": "..."}, atau {"type": "brosur_jadwal", "bulan": "2026-08"}. Maksimal 4; jadwal_id wajib dari hasil tool putaran ini, sedangkan brosur_jadwal cukup bulannya.
...
export async function runBaniConversation({
  ...
  return {
    ...
    media: hydrateBaniMedia(toolResults, parsed, { now }),
