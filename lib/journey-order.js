...
// Konten dianggap terbukti milik jadwal ini bila judul hari pertama yang
// bertanggal jatuh pada berangkat_tgl + indeks harinya. Toleransi ±1 hari:
// PDF keberangkatan lepas-tengah-malam menanggali hari-1 dengan hari kumpul
// di bandara, sehari sebelum tanggal berangkat resmi (pola JBU1565).
export function itineraryMatchesDepartureDate(content, berangkatTgl) {
  ...
  for (let i = 0; i < days.length; i += 1) {
    ...
    return Math.abs(dated - (departure + i * DAY_MS)) <= DAY_MS;
  }
  return false;
}
