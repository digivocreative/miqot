...
interface AgentProfileProps {
  agent: AgentData;
  packageName?: string; // Prop baru untuk nama paket dinamis
}

export default function AgentProfile({ agent, packageName = "Umrah Alhijaz" }: AgentProfileProps) {
