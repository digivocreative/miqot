  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center text-center">
        <div className={`mb-2 flex w-12 h-12 items-center justify-center rounded-xl ring-1 ring-white/40 transition-transform duration-200 group-hover:scale-110 dark:ring-white/10 ${menu.iconBg} ${menu.iconShadow}`}>
