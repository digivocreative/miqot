...
function GroupSection({
  ...
  const titleClass = tone === 'emerald' ? 'text-emerald-700' : tone === 'amber' ? 'text-amber-700' : 'text-slate-600';

  return (
    <section>
      <p className={`mb-3 text-[11px] font-semibold uppercase tracking-wider ${titleClass}`}>{title}</p>
  ...
  return (
    <main className="mx-auto w-full max-w-md pb-28">
      ...
      <div className="space-y-4 px-4 pt-4">
        <section className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs text-slate-500">Status perlengkapan jamaah</p>
            </div>
        ...
        <div className="flex items-center justify-between gap-2 rounded-2xl border border-slate-100 bg-white px-4 py-3 text-[11px] font-semibold text-slate-600 shadow-sm">
        ...
        <section className="rounded-2xl border border-sky-100 bg-sky-50 p-4">
          <div className="flex items-start gap-3">
            <Info className="mt-0.5 h-4 w-4 flex-none text-sky-700" strokeWidth={2} />
