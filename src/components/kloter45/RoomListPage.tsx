                ...
                <ul className="divide-y divide-gray-50 dark:divide-slate-800/60">
                  {room.guests.map((guest) => (
                    <li key={guest.name} className="flex items-center gap-2.5 px-3 py-2">
                      <span className="flex h-7 w-7 flex-none items-center justify-center rounded-full bg-gray-100 text-[10px] font-extrabold text-gray-600 dark:bg-slate-800 dark:text-slate-300">
