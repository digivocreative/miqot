...
const TYPE_UMROH_RAMADHAN = PACKAGE_TYPE_UMROH_RAMADHAN;
const TYPE_UMROH_JUMATAIN = PACKAGE_TYPE_UMROH_JUMATAIN;
...
function brochureLabelForType(type: string, fallback: string): string {
  ...
  if (type === TYPE_UMROH_RAMADHAN) return 'RAMADHAN';
  if (type === TYPE_UMROH_JUMATAIN) return 'JUMATAIN';
