  ...
  return (
    ...
    >
      <div className="px-3.5 py-3">
        ...
        {/* ---- Row 2: Package Name ---- */}
        <h3 className={`text-[13px] font-extrabold uppercase tracking-wide truncate mb-0.5 ${
          isFull
        ...
        {/* ---- Row 3: Price ---- */}
        <p className="text-[12px] text-gray-600 dark:text-slate-300 mb-1.5">
          Mulai dari{' '}
        ...
        <div className="grid grid-cols-2 gap-x-4">
          ...
          <div className="text-[11px] leading-[1.6]">
            ...
            <p className="flex items-center gap-1 font-semibold text-gray-700 dark:text-slate-200">
              <PlaneTakeoff size={11} className="text-emerald-500 shrink-0" />
          ...
          {/* Right: Return */}
          <div className="text-[11px] text-right leading-[1.6]">
