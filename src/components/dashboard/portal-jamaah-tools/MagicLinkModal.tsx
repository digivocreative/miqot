            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              <div className="rounded-2xl border border-gray-100 dark:border-slate-700 bg-gray-50/80 dark:bg-slate-900/40 p-3">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="text-sm font-bold text-gray-900 dark:text-slate-100 truncate mt-1">{jamaahName}</p>
                    <p className="text-xs text-gray-500 dark:text-slate-400 truncate">{waNumber || jamaahWa || 'Nomor WA belum ada'}</p>
                  </div>
              ...
              <div className="rounded-2xl border border-gray-100 dark:border-slate-700 bg-gray-50/80 dark:bg-slate-900/40 p-3">
                <div className="flex items-center justify-between gap-2 mb-2">
                  <p className="text-[10px] uppercase tracking-wider font-bold text-gray-400 dark:text-slate-500">Generated URL</p>
                  <button
                    type="button"
