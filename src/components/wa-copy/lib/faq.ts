...
export const FAQ_CATEGORIES: CategoryMeta<FaqCategory>[] = [
  { value: 'umum', label: 'Umum', icon: HelpCircle, tip: 'Pertanyaan dasar calon jamaah.' },
  { value: 'pembayaran', label: 'Pembayaran', icon: CreditCard, tip: 'Cara bayar, DP, dan pelunasan.' },
  { value: 'dokumen', label: 'Dokumen', icon: FileText, tip: 'Paspor dan berkas wajib.' },
  { value: 'keberangkatan', label: 'Keberangkatan', icon: Plane, tip: 'Manasik, bagasi, dan titik kumpul.' },
  { value: 'fasilitas', label: 'Fasilitas', icon: BedDouble, tip: 'Hotel, makan, dan yang termasuk paket.' },
];
