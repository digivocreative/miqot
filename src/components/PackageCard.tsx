    ...
    >
      ...
      >
        <div ref={contentRef} className="px-4 pb-4">
          ...
          {/* ---- Unified Contact Card (Hidden) ---- */}
          {/* 
          <div 
            className="-mt-1 mb-2.5 bg-emerald-50 border border-emerald-100 rounded-xl p-4 cursor-pointer hover:bg-emerald-100/70 transition-colors"
            onClick={(e) => {
              e.stopPropagation();
              handleWhatsAppShare();
            }}
          >
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-3 flex-1 min-w-0">
                <div className="w-11 h-11 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white font-bold text-base shadow-md overflow-hidden shrink-0">
                  {agent.photo ? (
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <p className="text-xs text-emerald-600 truncate">Travel Consultant</p>
                </div>
              </div>
              ...
              >
                ...
                <span className="hidden sm:inline">Chat via WA</span>
