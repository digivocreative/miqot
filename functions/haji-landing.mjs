...
var WA_SVG = '<svg viewBox="0 0 24 24" fill="currentColor" style="width:20px;height:20px"><path d="' + WA_PATH + '"/></svg>';
...
async function generateHTML(slug, agentOverride) {
  ...
  const agentPhoto = agentOverride?.photo || "https://sb.alhijaz.co/storage/v1/object/public/agent-photos/" + slug + ".jpg";
